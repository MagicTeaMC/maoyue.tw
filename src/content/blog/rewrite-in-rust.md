...
None of this is surprising. Every new projects - no matter which language is used require time and scrutiny to reach the stability of 40-year-old tools. In fact, I don't think RIIR is bad, it is a movement to switch from legacy C to modern language, open source communities always like to try out new thing!

The major problem of sudo-rs is that they should never deceiving users by claiming "My project is more secure than original one!". They succesfully "mislead" people considered sudo-rs to be better than sudo. For instance, Canonical has replaced sudo to sudo-rs in Ubuntu 25.10, leaving millions of computers at unnecessary risk.
