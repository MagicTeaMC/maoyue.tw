...
由此可見，只要 Anthropic 的系統「偵測到異常」，他們能夠直接查看你的對話。這就代表，即使他們的系統如實運作（看起來有...嗎？），只要發生類似[臉書「大規模誤判」](https://www.setn.com/News.aspx?NewsID=1856880)的情形（臉書自己說這是系統異常），Anthropic 就可以「合法的」翻閱你的對話紀錄。萬一曾與 AI 討論過公司的機密技術，此刻卻可能變成他們資料庫中的公開檔案，而現在還得被迫實名認證來證明自己不是小孩，這豈不荒謬？而你在創帳號時已經匆匆點過「我同意」了。
